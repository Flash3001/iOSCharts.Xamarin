...
namespace iOSCharts
{
	// @[Protocol] interface ChartData : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts9ChartData")]
	[Protocol] interface ChartData
	{
		...
		// @property (readonly, copy, nonatomic) NSArray<NSObject *> * _Nonnull xValsObjc;
		[Export ("xValsObjc", ArgumentSemantic.Copy)]
		NSObject[] XValsObjc { get; }
	}

	// @[Protocol] interface BarLineScatterCandleBubbleChartData : ChartData
	[BaseType (typeof(ChartData), Name = "_TtC6Charts35BarLineScatterCandleBubbleChartData")]
	[Protocol] interface BarLineScatterCandleBubbleChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface BarChartData : BarLineScatterCandleBubbleChartData
	[BaseType (typeof(BarLineScatterCandleBubbleChartData), Name = "_TtC6Charts12BarChartData")]
	[Protocol] interface BarChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface ChartDataEntry : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts14ChartDataEntry")]
	[Protocol] interface ChartDataEntry
	{
	...
	// @[Protocol] interface BarChartDataEntry : ChartDataEntry
	[BaseType (typeof(ChartDataEntry), Name = "_TtC6Charts17BarChartDataEntry")]
	[Protocol] interface BarChartDataEntry
	{
	...
	[Model, Protocol(Name = "_TtP6Charts20BarChartDataProvider_")]
	...
	[Model, Protocol(Name = "_TtP6Charts13IChartDataSet_")]
	interface InterfaceChartDataSet
	{
		...
		// @required -(NSInteger)entryIndexWithXIndex:(NSInteger)x;
		[Abstract]
	...
	interface IInterfaceChartDataSet// : IInterfaceChartDataSet
	{
	...
	// @protocol IBarChartDataSet <IInterfaceBarLineScatterCandleBubbleChartDataSet>
	//[BaseType(typeof(IInterfaceBarLineScatterCandleBubbleChartDataSet))]
	...
	// @[Protocol] interface ChartBaseDataSet : NSObject <IInterfaceChartDataSet>
	[BaseType (typeof(NSObject), Name = "_TtC6Charts16ChartBaseDataSet")]
	[Protocol] interface ChartBaseDataSet : InterfaceBarChartDataSet
	{
	...
	// @[Protocol] interface ChartDataSet : ChartBaseDataSet
	[BaseType (typeof(ChartBaseDataSet), Name = "_TtC6Charts12ChartDataSet")]
	[Protocol] interface ChartDataSet : InterfaceBarChartDataSet
	{
		// -(instancetype _Nonnull)initWithLabel:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithLabel:")]
		[DesignatedInitializer]
		...
		// @property (readonly, copy, nonatomic) NSArray<ChartDataEntry *> * _Nonnull yVals;
	...
	// @[Protocol] interface BarLineScatterCandleBubbleChartDataSet : ChartDataSet <IInterfaceBarLineScatterCandleBubbleChartDataSet>
	[BaseType (typeof(ChartDataSet), Name = "_TtC6Charts38BarLineScatterCandleBubbleChartDataSet")]
	[Protocol] interface BarLineScatterCandleBubbleChartDataSet : InterfaceBarLineScatterCandleBubbleChartDataSet
	{
	...
	// @[Protocol] interface BarChartDataSet : BarLineScatterCandleBubbleChartDataSet <IBarChartDataSet>
	[BaseType (typeof(BarLineScatterCandleBubbleChartDataSet), Name = "_TtC6Charts15BarChartDataSet")]
	[Protocol] interface BarChartDataSet : InterfaceBarChartDataSet
	{
		// -(instancetype _Nonnull)initWithYVals:(NSArray<ChartDataEntry *> * _Nullable)yVals label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithYVals:label:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface ChartHighlighter : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts16ChartHighlighter")]
	[Protocol] interface ChartHighlighter
	{
		...
		[return: NullAllowed]
		ChartHighlight GetHighlightWithX (double x, double y);

		// -(NSInteger)getXIndex:(double)x;
		[Export ("getXIndex:")]
		nint GetXIndex (double x);

		// -(NSInteger)getDataSetIndexWithXIndex:(NSInteger)xIndex x:(double)x y:(double)y;
		[Export ("getDataSetIndexWithXIndex:x:y:")]
		nint GetDataSetIndexWithXIndex (nint xIndex, double x, double y);
	...
	// @[Protocol] interface BarChartHighlighter : ChartHighlighter
	[BaseType (typeof(ChartHighlighter), Name = "_TtC6Charts19BarChartHighlighter")]
	[Protocol] interface BarChartHighlighter
	{
		// -(ChartHighlight * _Nullable)getHighlightWithX:(double)x y:(double)y;
		[Export ("getHighlightWithX:y:")]
		[return: NullAllowed]
		...
		[Export ("getStackedHighlightWithOld:set:xIndex:dataSetIndex:yValue:")]
		[return: NullAllowed]
		ChartHighlight GetStackedHighlightWithOld ([NullAllowed] ChartHighlight old, BarChartDataSet set, nint xIndex, nint dataSetIndex, double yValue);
	...
	// @[Protocol] interface ChartRendererBase : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts17ChartRendererBase")]
	[Protocol] interface ChartRendererBase
	{
	...
	// @[Protocol] interface ChartDataRendererBase : ChartRendererBase
	[BaseType (typeof(ChartRendererBase), Name = "_TtC6Charts21ChartDataRendererBase")]
	[Protocol] interface ChartDataRendererBase
	{
	...
	// @[Protocol] interface BarChartRenderer : ChartDataRendererBase
	[BaseType (typeof(ChartDataRendererBase), Name = "_TtC6Charts16BarChartRenderer" )]
	[Protocol] interface BarChartRenderer
	{
		...
		//unsafe void DrawDataSetWithContext (CGContextRef* context, IBarChartDataSet dataSet, nint index);
	...
	// @[Protocol] interface NSUIView : UIView
	[BaseType (typeof(UIView), Name = "_TtC6Charts8NSUIView")]
	[Protocol] interface NSUIView
	{
	...
	// @[Protocol] interface ChartViewBase : NSUIView <ChartAnimatorDelegate, ChartDataProvider>
	[BaseType (typeof(NSUIView), Name = "_TtC6Charts13ChartViewBase")]
	[Protocol] interface ChartViewBase : ChartAnimatorDelegate, ChartDataProvider
	{
		...
		[Export ("_deltaX")]
		nfloat _deltaX { get; set; }

		// @property (nonatomic) double _chartXMin;
		[Export ("_chartXMin")]
		double _chartXMin { get; set; }

		// @property (nonatomic) double _chartXMax;
		[Export ("_chartXMax")]
		double _chartXMax { get; set; }
	...
	// @[Protocol] interface BarLineChartViewBase : ChartViewBase <BarLineScatterCandleBubbleChartDataProvider, UIGestureRecognizerDelegate>
	[BaseType (typeof(ChartViewBase), Name = "_TtC6Charts20BarLineChartViewBase")]
	[Protocol] interface BarLineChartViewBase : BarLineScatterCandleBubbleChartDataProvider, ChartAnimatorDelegate, IUIGestureRecognizerDelegate
	{
	...
	// @[Protocol] interface BarChartView : BarLineChartViewBase <BarChartDataProvider>
	[BaseType (typeof(BarLineChartViewBase), Name = "_TtC6Charts12BarChartView")]
	[Protocol] interface BarChartView : BarChartDataProvider, ChartAnimatorDelegate
	{
		// -(void)initialize;
		[Export ("initialize")]
		void Initialize ();
	...
	// @[Protocol] interface BubbleChartData : BarLineScatterCandleBubbleChartData
	[BaseType (typeof(BarLineScatterCandleBubbleChartData), Name = "_TtC6Charts15BubbleChartData")]
	[Protocol] interface BubbleChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface BubbleChartDataEntry : ChartDataEntry
	[BaseType (typeof(ChartDataEntry), Name = "_TtC6Charts20BubbleChartDataEntry")]
	[Protocol] interface BubbleChartDataEntry
	{
	...
	// @protocol IBubbleChartDataSet <IInterfaceBarLineScatterCandleBubbleChartDataSet>
	...
	// @[Protocol] interface BubbleChartDataSet : BarLineScatterCandleBubbleChartDataSet <IBubbleChartDataSet>
	[BaseType (typeof(BarLineScatterCandleBubbleChartDataSet), Name = "_TtC6Charts18BubbleChartDataSet")]
	[Protocol] interface BubbleChartDataSet : InterfaceBubbleChartDataSet
	{
	...
	// @[Protocol] interface BubbleChartRenderer : ChartDataRendererBase
	[BaseType (typeof(ChartDataRendererBase), Name = "_TtC6Charts19BubbleChartRenderer")]
	[Protocol] interface BubbleChartRenderer
	{
		...
		//unsafe void DrawDataSetWithContext (CGContextRef* context, IBubbleChartDataSet dataSet);
	...
	// @[Protocol] interface BubbleChartView : BarLineChartViewBase <BubbleChartDataProvider>
	[BaseType (typeof(BarLineChartViewBase), Name = "_TtC6Charts15BubbleChartView")]
	[Protocol] interface BubbleChartView : BubbleChartDataProvider, ChartAnimatorDelegate
	{
		// -(void)initialize;
		[Export ("initialize")]
		void Initialize ();
	...
	// @[Protocol] interface CandleChartData : BarLineScatterCandleBubbleChartData
	[BaseType (typeof(BarLineScatterCandleBubbleChartData), Name = "_TtC6Charts15CandleChartData")]
	[Protocol] interface CandleChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface CandleChartDataEntry : ChartDataEntry
	[BaseType (typeof(ChartDataEntry), Name = "_TtC6Charts20CandleChartDataEntry")]
	[Protocol] interface CandleChartDataEntry
	{
	...
	// @protocol ILineScatterCandleRadarChartDataSet <IInterfaceBarLineScatterCandleBubbleChartDataSet>
	...
	interface InterfaceLineScatterCandleRadarChartDataSet : InterfaceBarLineScatterCandleBubbleChartDataSet
	{
		...
		bool DrawHorizontLineChartViewalHighlightIndicatorEnabled { get; set; }
	...
	// @[Protocol] interface LineScatterCandleRadarChartDataSet : BarLineScatterCandleBubbleChartDataSet <ILineScatterCandleRadarChartDataSet>
	[BaseType (typeof(BarLineScatterCandleBubbleChartDataSet), Name = "_TtC6Charts34LineScatterCandleRadarChartDataSet")]
	[Protocol] interface LineScatterCandleRadarChartDataSet : InterfaceLineScatterCandleRadarChartDataSet
	{
...
//		bool DrawHorizontalHighlightIndicatorEnabled { get; set; }
	...
	// @[Protocol] interface CandleChartDataSet : LineScatterCandleRadarChartDataSet <ICandleChartDataSet>
	[BaseType (typeof(LineScatterCandleRadarChartDataSet), Name = "_TtC6Charts18CandleChartDataSet")]
	[Protocol] interface CandleChartDataSet : InterfaceCandleChartDataSet
	{
		// -(instancetype _Nonnull)initWithYVals:(NSArray<ChartDataEntry *> * _Nullable)yVals label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithYVals:label:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface LineScatterCandleRadarChartRenderer : ChartDataRendererBase
	[BaseType (typeof(ChartDataRendererBase), Name = "_TtC6Charts35LineScatterCandleRadarChartRenderer")]
	[Protocol] interface LineScatterCandleRadarChartRenderer
	{
		// -(instancetype _Nonnull)initWithAnimator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler __attribute__((objc_designated_initializer));
		[Export ("initWithAnimator:viewPortHandler:")]
		[DesignatedInitializer]
		...
		//unsafe void DrawHighlightLinesWithContext (CGContextRef* context, CGPoint point, ILineScatterCandleRadarChartDataSet set);
	}

	// @[Protocol] interface CandleStickChartRenderer : LineScatterCandleRadarChartRenderer
	[BaseType (typeof(LineScatterCandleRadarChartRenderer), Name = "_TtC6Charts24CandleStickChartRenderer")]
	[Protocol] interface CandleStickChartRenderer
	{
		...
		//[Export ("drawDataSetWithContext:dataSet:")]
		//unsafe void DrawDataSetWithContext (CGContextRef* context, ICandleChartDataSet dataSet);
	...
	// @[Protocol] interface CandleStickChartView : BarLineChartViewBase <CandleChartDataProvider>
	[BaseType (typeof(BarLineChartViewBase), Name = "_TtC6Charts20CandleStickChartView")]
	[Protocol] interface CandleStickChartView : CandleChartDataProvider, ChartAnimatorDelegate
	{
		// -(void)initialize;
		[Export ("initialize")]
		void Initialize ();
	...
	// @[Protocol] interface ChartAnimator : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts13ChartAnimator")]
	[Protocol] interface ChartAnimator
	{
		//[Wrap ("WeakDelegate")]
		//[NullAllowed]
	...
	// @[Protocol] interface ChartComponentBase : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts18ChartComponentBase" )]
	[Protocol] interface ChartComponentBase
	{
	...
	// @[Protocol] interface ChartAxisBase : ChartComponentBase
	[BaseType (typeof(ChartComponentBase), Name = "_TtC6Charts13ChartAxisBase" )]
	[Protocol] interface ChartAxisBase
	{
	...
	// @[Protocol] interface ChartAxisRendererBase : ChartRendererBase
	[BaseType (typeof(ChartRendererBase), Name = "_TtC6Charts21ChartAxisRendererBase")]
	[Protocol] interface ChartAxisRendererBase
	{
	...
	// @[Protocol] interface ChartColorTemplates : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts19ChartColorTemplates")]
	[Protocol] interface ChartColorTemplates
	{
	...
	// @[Protocol] interface ChartDataBaseFilter : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts19ChartDataBaseFilter")]
	[Protocol] interface ChartDataBaseFilter
	{
	...
	// @[Protocol] interface ChartDataApproximatorFilter : ChartDataBaseFilter
	[BaseType (typeof(ChartDataBaseFilter), Name = "_TtC6Charts27ChartDataApproximatorFilter")]
	[Protocol] interface ChartDataApproximatorFilter
	{
	...
	{
		// @required -(CGFloat)getFillLinePositionWithDataSet:(id<ILineChartDataSet> _Nonnull)dataSet dataProvider:(id<LineChartDataProvider> _Nonnull)dataProvider;
//		[Abstract]
...
//		nfloat DataProvider (IInterfaceLineChartDataSet dataSet, ILineChartDataProvider dataProvider);
	...
	// @[Protocol] interface ChartDefaultFillFormatter : NSObject <ChartFillFormatter>
	[BaseType (typeof(NSObject), Name = "_TtC6Charts25ChartDefaultFillFormatter")]
	[Protocol] interface ChartDefaultFillFormatter : ChartFillFormatter
	{
...
//		string Original (nint index, string original, ChartViewPortHandler viewPortHandler);
	...
	// @[Protocol] interface ChartDefaultXAxisValueFormatter : NSObject <ChartXAxisValueFormatter>
	[BaseType (typeof(NSObject), Name = "_TtC6Charts31ChartDefaultXAxisValueFormatter")]
	[Protocol] interface ChartDefaultXAxisValueFormatter : ChartXAxisValueFormatter
	{
	...
	// @[Protocol] interface ChartFill : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts9ChartFill")]
	[Protocol] interface ChartFill
	{
	...
	// @[Protocol] interface ChartHighlight : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts14ChartHighlight")]
	[Protocol] interface ChartHighlight
	{
	...
	// @[Protocol] interface ChartLegend : ChartComponentBase
	[BaseType (typeof(ChartComponentBase), Name = "_TtC6Charts11ChartLegend")]
	[Protocol] interface ChartLegend
	{
	...
	// @[Protocol] interface ChartLegendRenderer : ChartRendererBase
	[BaseType (typeof(ChartRendererBase), Name = "_TtC6Charts19ChartLegendRenderer")]
	[Protocol] interface ChartLegendRenderer
	{
	...
	// @[Protocol] interface ChartLimitLine : ChartComponentBase
	[BaseType (typeof(ChartComponentBase), Name = "_TtC6Charts14ChartLimitLine")]
	[Protocol] interface ChartLimitLine
	{
	...
	// @[Protocol] interface ChartMarker : ChartComponentBase
	[BaseType (typeof(ChartComponentBase), Name = "_TtC6Charts11ChartMarker")]
	[Protocol] interface ChartMarker
	{
	...
	// @[Protocol] interface ChartRange : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts10ChartRange")]
	[Protocol] interface ChartRange
	{
	...
	// @[Protocol] interface ChartSelectionDetail : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts20ChartSelectionDetail")]
	[Protocol] interface ChartSelectionDetail
	{
		// -(instancetype _Nonnull)initWithValue:(double)value dataSetIndex:(NSInteger)dataSetIndex dataSet:(id<IInterfaceChartDataSet> _Nonnull)dataSet __attribute__((objc_designated_initializer));
	...
	// @[Protocol] interface ChartTransformer : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts16ChartTransformer")]
	[Protocol] interface ChartTransformer
	{
	...
	// @[Protocol] interface ChartTransformerHorizontalBarChart : ChartTransformer
	[BaseType (typeof(ChartTransformer), Name = "_TtC6Charts34ChartTransformerHorizontalBarChart")]
	[Protocol] interface ChartTransformerHorizontalBarChart
	{
		// -(void)prepareMatrixOffset:(BOOL)inverted;
		[Export ("prepareMatrixOffset:")]
		void PrepareMatrixOffset (bool inverted);
	...
	// @[Protocol] interface ChartViewPortHandler : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC6Charts20ChartViewPortHandler")]
	[Protocol] interface ChartViewPortHandler
	{
	...
	// @[Protocol] interface ChartXAxis : ChartAxisBase
	[BaseType (typeof(ChartAxisBase), Name = "_TtC6Charts10ChartXAxis")]
	[Protocol] interface ChartXAxis
	{
	...
	// @[Protocol] interface ChartXAxisRenderer : ChartAxisRendererBase
	[BaseType (typeof(ChartAxisRendererBase), Name = "_TtC6Charts18ChartXAxisRenderer")]
	[Protocol] interface ChartXAxisRenderer
	{
	...
	// @[Protocol] interface ChartXAxisRendererBarChart : ChartXAxisRenderer
	[BaseType (typeof(ChartXAxisRenderer), Name = "_TtC6Charts26ChartXAxisRendererBarChart")]
	[Protocol] interface ChartXAxisRendererBarChart
	{
	...
	// @[Protocol] interface ChartXAxisRendererHorizontalBarChart : ChartXAxisRendererBarChart
	[BaseType (typeof(ChartXAxisRendererBarChart), Name = "_TtC6Charts36ChartXAxisRendererHorizontalBarChart")]
	[Protocol] interface ChartXAxisRendererHorizontalBarChart
	{
		// -(instancetype _Nonnull)initWithViewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler xAxis:(ChartXAxis * _Nonnull)xAxis transformer:(ChartTransformer * _Null_unspecified)transformer chart:(BarChartView * _Nonnull)chart __attribute__((objc_designated_initializer));
		[Export ("initWithViewPortHandler:xAxis:transformer:chart:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface ChartXAxisRendererRadarChart : ChartXAxisRenderer
	[BaseType (typeof(ChartXAxisRenderer), Name = "_TtC6Charts28ChartXAxisRendererRadarChart")]
	[Protocol] interface ChartXAxisRendererRadarChart
	{
	...
	// @[Protocol] interface ChartYAxis : ChartAxisBase
	[BaseType (typeof(ChartAxisBase), Name = "_TtC6Charts10ChartYAxis")]
	[Protocol] interface ChartYAxis
	{
	...
	// @[Protocol] interface ChartYAxisRenderer : ChartAxisRendererBase
	[BaseType (typeof(ChartAxisRendererBase), Name = "_TtC6Charts18ChartYAxisRenderer")]
	[Protocol] interface ChartYAxisRenderer
	{
	...
	// @[Protocol] interface ChartYAxisRendererHorizontalBarChart : ChartYAxisRenderer
	[BaseType (typeof(ChartYAxisRenderer), Name = "_TtC6Charts36ChartYAxisRendererHorizontalBarChart")]
	[Protocol] interface ChartYAxisRendererHorizontalBarChart
	{
		// -(instancetype _Nonnull)initWithViewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler yAxis:(ChartYAxis * _Nonnull)yAxis transformer:(ChartTransformer * _Null_unspecified)transformer __attribute__((objc_designated_initializer));
		[Export ("initWithViewPortHandler:yAxis:transformer:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface ChartYAxisRendererRadarChart : ChartYAxisRenderer
	[BaseType (typeof(ChartYAxisRenderer), Name = "_TtC6Charts28ChartYAxisRendererRadarChart")]
	[Protocol] interface ChartYAxisRendererRadarChart
	{
	...
	// @[Protocol] interface CombinedChartData : BarLineScatterCandleBubbleChartData
	[BaseType (typeof(BarLineScatterCandleBubbleChartData), Name = "_TtC6Charts17CombinedChartData")]
	[Protocol] interface CombinedChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface CombinedChartRenderer : ChartDataRendererBase
	[BaseType (typeof(ChartDataRendererBase), Name = "_TtC6Charts21CombinedChartRenderer")]
	[Protocol] interface CombinedChartRenderer
	{
	...
	// @[Protocol] interface CombinedChartView : BarLineChartViewBase <BarChartDataProvider, ScatterChartDataProvider, CandleChartDataProvider, BubbleChartDataProvider, LineChartDataProvider>
	[BaseType (typeof(BarLineChartViewBase), Name = "_TtC6Charts17CombinedChartView")]
	[Protocol] interface CombinedChartView : BarChartDataProvider, ScatterChartDataProvider, CandleChartDataProvider, BubbleChartDataProvider, LineChartDataProvider, ChartAnimatorDelegate
	{
		...
		//ChartFillFormatter _fillFormatter { get; set; }
	...
	// @[Protocol] interface CombinedHighlighter : ChartHighlighter
	[BaseType (typeof(ChartHighlighter), Name = "_TtC6Charts19CombinedHighlighter")]
	[Protocol] interface CombinedHighlighter
	{
		// -(NSArray<ChartSelectionDetail *> * _Nonnull)getSelectionDetailsAtIndex:(NSInteger)xIndex;
		[Export ("getSelectionDetailsAtIndex:")]
		ChartSelectionDetail[] GetSelectionDetailsAtIndex (nint xIndex);
	...
	// @[Protocol] interface HorizontalBarChartHighlighter : BarChartHighlighter
	[BaseType (typeof(BarChartHighlighter), Name = "_TtC6Charts29HorizontalBarChartHighlighter")]
	[Protocol] interface HorizontalBarChartHighlighter
	{
		// -(ChartHighlight * _Nullable)getHighlightWithX:(double)x y:(double)y;
		[Export ("getHighlightWithX:y:")]
		[return: NullAllowed]
	...
	// @[Protocol] interface HorizontalBarChartRenderer : BarChartRenderer
	[BaseType (typeof(BarChartRenderer), Name = "_TtC6Charts26HorizontalBarChartRenderer")]
	[Protocol] interface HorizontalBarChartRenderer
	{
		//// -(instancetype _Nonnull)initWithDataProvider:(id<BarChartDataProvider> _Nullable)dataProvider animator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler __attribute__((objc_designated_initializer));
		//[Export ("initWithDataProvider:animator:viewPortHandler:")]
		//[DesignatedInitializer]
	...
	[Protocol] interface HorizontalBarChartView : ChartAnimatorDelegate, BarLineScatterCandleBubbleChartDataProvider
	{
		// -(void)initialize;
		[Export ("initialize")]
		void Initialize ();
	...
	interface InterfaceLineChartDataSet : InterfaceLineRadarChartDataSet
	{
		...
		// @required @property (nonatomic, strong) UIColor * _Nonnull circleHoleColor;
		[Export ("circleHoleColor", ArgumentSemantic.Strong)]
	...
	// @protocol IPieChartDataSet <IInterfaceChartDataSet>
	[Protocol(Name = "_TtP6Charts16IPieChartDataSet_"), Model]
	interface InterfacePieChartDataSet : InterfaceChartDataSet
	{
		// @required @property (readonly, nonatomic) double yValueSum;
		[Export ("yValueSum")]
		double YValueSum { get; }

		// @required @property (readonly, nonatomic) double average;
		[Export ("average")]
		double Average { get; }
	...
	// @[Protocol] [Protocol] interface LineChartData : ChartData
	[BaseType (typeof(ChartData), Name = "_TtC6Charts13LineChartData")]
	[Protocol] interface LineChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface LineRadarChartDataSet : LineScatterCandleRadarChartDataSet <ILineRadarChartDataSet>
	[BaseType (typeof(LineScatterCandleRadarChartDataSet), Name = "_TtC6Charts21LineRadarChartDataSet")]
	[Protocol] interface LineRadarChartDataSet : InterfaceLineRadarChartDataSet
	{
	...
	// @[Protocol] interface LineChartDataSet : LineRadarChartDataSet <ILineChartDataSet>
	[BaseType (typeof(LineRadarChartDataSet), Name = "_TtC6Charts16LineChartDataSet")]
	[Protocol] interface LineChartDataSet : InterfaceLineChartDataSet
	{
		// -(instancetype _Nonnull)initWithYVals:(NSArray<ChartDataEntry *> * _Nullable)yVals label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithYVals:label:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface LineRadarChartRenderer : LineScatterCandleRadarChartRenderer
	[BaseType (typeof(LineScatterCandleRadarChartRenderer), Name = "_TtC6Charts22LineRadarChartRenderer")]
	[Protocol] interface LineRadarChartRenderer
	{
		// -(instancetype _Nonnull)initWithAnimator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler __attribute__((objc_designated_initializer));
		[Export ("initWithAnimator:viewPortHandler:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface LineChartRenderer : LineRadarChartRenderer
	[BaseType (typeof(LineRadarChartRenderer), Name = "_TtC6Charts17LineChartRenderer")]
	[Protocol] interface LineChartRenderer
	{
		...
		//[Export ("drawDataSetWithContext:dataSet:")]
		//unsafe void DrawDataSetWithContext (CGContextRef* context, ILineChartDataSet dataSet);

		//// -(void)drawCubicWithContext:(CGContextRef _Nonnull)context dataSet:(id<ILineChartDataSet> _Nonnull)dataSet;
		//[Export ("drawCubicWithContext:dataSet:")]
		//unsafe void DrawCubicWithContext (CGContextRef* context, ILineChartDataSet dataSet);
		...
		//unsafe void DrawCubicFillWithContext (CGContextRef* context, ILineChartDataSet dataSet, CGMutablePathRef* spline, CGAffineTransform matrix, nint from, nint to);
		...
		//unsafe void DrawLinearWithContext (CGContextRef* context, ILineChartDataSet dataSet);
		...
		//unsafe void DrawLinearFillWithContext (CGContextRef* context, ILineChartDataSet dataSet, nint minx, nint maxx, ChartTransformer trans);
	...
	// @[Protocol] interface LineChartView : BarLineChartViewBase <LineChartDataProvider>
	[BaseType (typeof(BarLineChartViewBase), Name = "_TtC6Charts13LineChartView")]
	[Protocol] interface LineChartView : LineChartDataProvider, ChartAnimatorDelegate
	{
		// -(void)initialize;
		[Export ("initialize")]
		void Initialize ();
	...
	// @[Protocol] interface PieChartData : ChartData
	[BaseType (typeof(ChartData), Name = "_TtC6Charts12PieChartData")]
	[Protocol] interface PieChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
		...
		[NullAllowed, Export ("dataSet", ArgumentSemantic.Strong)]
		PieChartDataSet DataSet { get; set; }
	...
	// @[Protocol] interface PieChartDataSet : ChartDataSet <IPieChartDataSet>
	[BaseType (typeof(ChartDataSet), Name = "_TtC6Charts15PieChartDataSet")]
	[Protocol] interface PieChartDataSet : InterfacePieChartDataSet
	{
		// -(instancetype _Nonnull)initWithYVals:(NSArray<ChartDataEntry *> * _Nullable)yVals label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithYVals:label:")]
		[DesignatedInitializer]
...
//		bool RemoveLast { get; }
	...
	// @[Protocol] interface PieChartRenderer : ChartDataRendererBase
	[BaseType (typeof(ChartDataRendererBase), Name = "_TtC6Charts16PieChartRenderer")]
	[Protocol] interface PieChartRenderer
	{
		...
		//[Export ("drawDataSetWithContext:dataSet:")]
		//unsafe void DrawDataSetWithContext (CGContextRef* context, IPieChartDataSet dataSet);
	...
	// @[Protocol] interface PieRadarChartViewBase : ChartViewBase
	[BaseType (typeof(ChartViewBase), Name = "_TtC6Charts21PieRadarChartViewBase")]
	[Protocol] interface PieRadarChartViewBase : ChartAnimatorDelegate
	{
	...
	// @[Protocol] interface PieChartView : PieRadarChartViewBase
	[BaseType (typeof(PieRadarChartViewBase), Name = "_TtC6Charts12PieChartView")]
	[Protocol] interface PieChartView : ChartAnimatorDelegate
	{
		// -(instancetype _Nonnull)initWithFrame:(CGRect)frame __attribute__((objc_designated_initializer));
		[Export ("initWithFrame:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface RadarChartData : ChartData
	[BaseType (typeof(ChartData), Name = "_TtC6Charts14RadarChartData")]
	[Protocol] interface RadarChartData
	{
		// @property (nonatomic, strong) UIColor * _Nonnull highlightColor;
		[Export ("highlightColor", ArgumentSemantic.Strong)]
		UIColor HighlightColor { get; set; }
	...
	// @[Protocol] interface RadarChartDataSet : LineRadarChartDataSet <IRadarChartDataSet>
	[BaseType (typeof(LineRadarChartDataSet), Name = "_TtC6Charts17RadarChartDataSet")]
	[Protocol] interface RadarChartDataSet : InterfaceRadarChartDataSet
	{
		// -(instancetype _Nonnull)initWithYVals:(NSArray<ChartDataEntry *> * _Nullable)yVals label:(NSString * _Nullable)label __attribute__((objc_designated_initializer));
		[Export ("initWithYVals:label:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface RadarChartRenderer : LineRadarChartRenderer
	[BaseType (typeof(LineRadarChartRenderer), Name = "_TtC6Charts18RadarChartRenderer")]
	[Protocol] interface RadarChartRenderer
	{
		// @property (nonatomic, weak) RadarChartView * _Nullable chart;
		[NullAllowed, Export ("chart", ArgumentSemantic.Weak)]
		RadarChartView Chart { get; set; }
		...
		//unsafe void DrawDataSetWithContext (CGContextRef* context, IRadarChartDataSet dataSet, nint mostEntries);
	...
	[Protocol] interface RadarChartView : ChartAnimatorDelegate
	{
	...
	// @[Protocol] interface ScatterChartData : BarLineScatterCandleBubbleChartData
	[BaseType (typeof(BarLineScatterCandleBubbleChartData), Name = "_TtC6Charts16ScatterChartData")]
	[Protocol] interface ScatterChartData
	{
		// -(instancetype _Nonnull)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id<IInterfaceChartDataSet>> * _Nullable)dataSets __attribute__((objc_designated_initializer));
		[Export ("initWithXVals:dataSets:")]
		[DesignatedInitializer]
	...
	// @[Protocol] interface ScatterChartDataSet : LineScatterCandleRadarChartDataSet <IScatterChartDataSet>
	[BaseType (typeof(LineScatterCandleRadarChartDataSet), Name = "_TtC6Charts19ScatterChartDataSet")]
	[Protocol] interface ScatterChartDataSet : InterfaceScatterChartDataSet
	{
	...
	// @[Protocol] interface ScatterChartRenderer : LineScatterCandleRadarChartRenderer
	[BaseType (typeof(LineScatterCandleRadarChartRenderer), Name = "_TtC6Charts20ScatterChartRenderer")]
	[Protocol] interface ScatterChartRenderer
	{
		...
		//[Export ("drawDataSetWithContext:dataSet:")]
		//unsafe void DrawDataSetWithContext (CGContextRef* context, IScatterChartDataSet dataSet);
	...
	[Protocol, BaseType (typeof(BarLineChartViewBase), Name = "_TtC6Charts16ScatterChartView")]
	interface ScatterChartView : ScatterChartDataProvider, ChartAnimatorDelegate
	{
		// -(void)initialize;
		[Export ("initialize")]
		void Initialize ();
	...
	// @interface Charts_Swift_4154 (UIPanGestureRecognizer)
	[Category]
	[BaseType (typeof(UIPanGestureRecognizer))]
	interface UIPanGestureRecognizer_Charts_Swift_4154
	{
	...
	// @interface Charts_Swift_4160 (UIPinchGestureRecognizer)
	[Category]
	[BaseType (typeof(UIPinchGestureRecognizer))]
	interface UIPinchGestureRecognizer_Charts_Swift_4160
	{
	...
	// @interface Charts_Swift_4166 (UIRotationGestureRecognizer)
	[Category]
	[BaseType (typeof(UIRotationGestureRecognizer))]
	interface UIRotationGestureRecognizer_Charts_Swift_4166
	{
	...
	// @interface Charts_Swift_4171 (UIScreen)
	[Category]
	[BaseType (typeof(UIScreen))]
	interface UIScreen_Charts_Swift_4171
	{
	...
	// @interface Charts_Swift_4176 (UITapGestureRecognizer)
	[Category]
	[BaseType (typeof(UITapGestureRecognizer))]
	interface UITapGestureRecognizer_Charts_Swift_4176
	{
		//// -(NSInteger)nsuiNumberOfTouches;
		//[Export ("nsuiNumberOfTouches")]
		////[Verify (MethodToProperty)]
	...
	// @interface Charts_Swift_4182 (UIView)BarChartDataSetBarChartDataSet
	[Category]
	[BaseType (typeof(UIView))]
	interface UIView_Charts_Swift_4182
	{
