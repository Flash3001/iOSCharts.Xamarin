...
namespace iOSCharts
{
    ...
    interface BubbleChartDataEntry
    {
        ...
        // -(instancetype _Nonnull)initWithX:(double)x y:(double)y size:(id)size icon:(UIImage * _Nullable)icon __attribute__((objc_designated_initializer));
        [Export("initWithX:y:size:icon:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, double y, nfloat size, [NullAllowed] UIImage icon);

        // -(instancetype _Nonnull)initWithX:(double)x y:(double)y size:(id)size icon:(UIImage * _Nullable)icon data:(id _Nullable)data __attribute__((objc_designated_initializer));
    ...
    interface CandleChartDataEntry
    {
        ...
        // -(instancetype _Nonnull)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(UIImage * _Nullable)icon __attribute__((objc_designated_initializer));
        ...
        // -(instancetype _Nonnull)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(UIImage * _Nullable)icon data:(id _Nullable)data __attribute__((objc_designated_initializer));
